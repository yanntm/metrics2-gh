 ...
 */
public class CohesionDCImod extends CohesionCalculator
{
    public CohesionDCImod() {
	super(DCI);
    }
	...
	List<Integer> methodsToEval =
	    CohesionDCDmod.getEvaluableMethodReachabilityIndices(callData);
	...
	ConnectivityMatrix directMatrix =
	    CohesionDCDmod.buildDirectlyConnectedMatrix(callData, methodsToEval);
